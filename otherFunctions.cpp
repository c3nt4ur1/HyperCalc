...
void help(){
    ...
    cout << "ENTER depois de cada valor. Para sair do programa, ao final do calculo, pressione qualquer tecla.\n";
}
void about(){
    cout << "This is a calculator for mathematical formulas, created by c3nt4ur1. It calculates all sorts of formulas, ";
    cout << "like geometrical formulas, or even Bhaskara's. It is developed in C++ in order to improve the program's ";
